...
try {
 ...
 const result={errors,overflow,checks:['no-session-selector','settings-columns','drag-reorder','active-only','auto-start-terminal','collapsed-by-default','active-profile','usage-bars','countdown','desktop-and-narrow']};
